...
int main(int argc, char **argv)
{
    ...
    // 初始化读写线程通信 ：  线程间通信置为0，初始值置为0
    sem_init(&rwsem, 0, 0);

    // 连接服务器成功，启动子线程[专门用于接收信息]
